...
<div class="corps">
	...
	<table class="largeTable">
		...
		<form method="post" action="<?php echo ROOT; ?>?v=ville&s1=new">
				...
				<td><input type="submit" class="inputSubmit" onclick="return confirm('Confirmez vous l\'ajout d\'une nouvelle ville ?<br>Cela supprimera les aeroports et terminaux associés');"value="Ajouter Ville" /></td>
		...
		<form method="post" action="<?php echo ROOT; ?>?v=ville&s1=del">
			...
			<td><input type="submit" class="inputSubmit" onclick="return confirm('Confirmez vous la suppression de la ville ?');"value="Supprimer Ville" /></td>
		</form>
		</tr>
	</table>
