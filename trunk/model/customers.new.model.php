...
if(isset($_POST, $_POST['newNom'], $_POST['newPrenom'], $_POST['newStatut']))
{
	...
	if(isset($nom))
	{
		try 
		{
			...
			{				
				if($_POST['newStatut'] == 'particulier' && isset($prenom))
				{
				...
				else if($_POST['newStatut'] == 'entreprise')
				{
					$newEntreprise = $bdd->prepare("INSERT INTO entreprise(id_client,nom) VALUES (:id_client, :nom)");
					$r = $newEntreprise->execute(array(":id_client" => $newId, ":nom" => $nom));
